...
plot factorial(x) title "factorial", "./data/Nacho/cena_gala_backtracking_cuentaperdida.dat"  with lines lt rgb "gold" title "cena_gala_backtracking_cuentaperdida"
...
fit factorial(x) "./data/Nacho/cena_gala_luis.dat" via a, b
plot factorial(x) title "factorial", "./data/Nacho/cena_gala_luis.dat"  with lines lt rgb "gold" title "cena_gala_luis"

set term png
set output "./grphx/Nacho/cena_gala_luis.png"
replot
set term x11
...
fit factorial(x) "./data/Nacho/cena_gala_diego.dat" via a, b
plot factorial(x) title "factorial", "./data/Nacho/cena_gala_diego.dat"  with lines lt rgb "gold" title "cena_gala_diego"

set term png
set output "./grphx/Nacho/cena_gala_diego.png"
replot
set term x11
