...
fit lineal(x) "./data/Luis/cena_gala_nacho.dat" via l0,l1
fit cuadratica(x) "./data/Luis/cena_gala_nacho.dat" via c0,c1,c2
plot lineal(x) title "Lineal", cuadratica(x) title "Cuadratica", "./data/Luis/cena_gala_nacho.dat" lt rgb "gold" title "Cena_gala_nacho"

set term png
set output "./grphx/Luis/cena_gala_nacho.png"
replot
set term x11
