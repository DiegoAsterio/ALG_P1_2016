...
plot "./data/Diego/datos_genera_unimodal_secuencial_Diego.dat", nlogaritmica(x), logaritmica(x)
...
plot "./data/Diego/datos_Parts_Diego.dat", nlogaritmica(x), logaritmica(x)
