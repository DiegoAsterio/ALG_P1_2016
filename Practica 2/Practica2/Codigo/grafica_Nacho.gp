...
plot "./data/Nacho/datos_genera_unimodal_secuencial_Nacho.dat", nlogaritmica(x), logaritmica(x)
...
plot "./data/Nacho/datos_Parts_Nacho.dat", nlogaritmica(x), logaritmica(x)
...
plot "./data/Nacho/datos_opcional_dyv_Nacho.dat", nlogaritmica(x), logaritmica(x)
