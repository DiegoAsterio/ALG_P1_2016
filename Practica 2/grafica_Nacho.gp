...
plot "./data/Nacho/datos_opcional_bruto_Nacho.dat", lineal(x), nlogaritmica(x), logaritmica(x)
...
fit lineal(x) "./data/Nacho/datos_opcional_dyv_Nacho.dat" via l0,l1
fit nlogaritmica(x) "./data/Nacho/datos_opcional_dyv_Nacho.dat" via n0,n1
fit logaritmica(x) "./data/Nacho/datos_opcional_dyv_Nacho.dat" via t0,t1,t2

plot "./data/Nacho/datos_opcional_dyv_Nacho.dat", lineal(x), nlogaritmica(x), logaritmica(x)

set term png
set output "./grphx/Nacho/opcional_dyv_Nacho.png"
replot
set term x11
