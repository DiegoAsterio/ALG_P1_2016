...
fit cuadratica(x) "./data/Luis/datos_opcional_bruto_Luis.dat" via c0,c1,c2

plot "./data/Luis/datos_opcional_bruto_Luis.dat", lineal(x), nlogaritmica(x), logaritmica(x), cuadratica(x)
...
fit nlogaritmica(x) "./data/Luis/datos_Parts_Luis.dat" via n0,n1
fit logaritmica(x) "./data/Luis/datos_Parts_Luis.dat" via t0,t1,t2

plot "./data/Luis/datos_Parts_Luis.dat", nlogaritmica(x), logaritmica(x)

set term png
set output "./grphx/Luis/Parts_Luis.png"
replot
set term x11
...
plot "./data/Luis/datos_opcional_dyv_Luis.dat", nlogaritmica(x), logaritmica(x)
