...
plot "./data/Miguel/datos_genera_unimodal_secuencial_Miguel.dat", lineal(x), nlogaritmica(x), logaritmica(x)
...
fit lineal(x) "./data/Miguel/datos_Parts_Miguel.dat" via l0,l1
...
plot "./data/Miguel/datos_Parts_Miguel.dat", lineal(x), nlogaritmica(x), logaritmica(x)
